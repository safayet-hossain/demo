            ...
            <table class="table table-dark">
                <thead>
                    <tr>
                        ...
                        <th scope="col">PHONE</th> <hr>
                        <th scope="col">Gender</th> <hr>
                        <th scope="col">Address</th> <hr>
                        <th scope="col">Age</th> <hr>
                        <th scope="col">Skill</th> <hr>
                     
                        <th scope="col">Image</th> <hr>
                        <th scope="col">CV</th> <hr>
                ...
                <tbody>
                    ...
                    <tr v-for="(item, index) in form" :key="index">
                        ...
                        <td>{{ item.address }}</td> <hr>
                        <td>{{ item.age }}</td> <hr>
                        <td>
                            <div v-for="(item, index) in JSON.parse(item.Skill)" :key="index">
                                {{item}}
                            </div>
                        </td> <hr>
                        <td><img :src="'http://localhost/laravel10-vue3/public/storage/uploads/'+item.image" width="100" ></td> <hr>
                        <td>
                            <a :href="'http://localhost/laravel10-vue3/public/storage/uploads/' +item.cv" class="btn btn-success"  >cv</a>
                        </td> <hr>
                        <td>
                            <router-link
...
export default {
    ...
    methods: {
        userlist() {
            // console.log('ache');
            axios.get("http://localhost/laravel10-vue3/public/get_employee_data").then((res) => {
                console.log('ok');
                this.form = res.data;
